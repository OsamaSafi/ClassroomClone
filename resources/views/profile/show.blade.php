                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6 mb-4 mb-lg-0">
                                    <img style="height: 500px;width: 500px;"
                                        src="{{ Storage::disk('public')->url($user->profile->user_img_path) }}"
                                        alt="...">
                                </div>
                                <div class="col-lg-6 px-xl-10">
                                    <div class="bg-secondary d-lg-inline-block py-1-9 px-1-9 px-sm-6 mb-1-9 rounded">
                                        ...
                                        <span
                                            class="text-primary">{{DB::table('classroom_user')->select('role')->where('user_id',$user->id)->first()->role}}</span>
                                    </div>
                                    <ul class="list-unstyled mb-1-9">
                                        <li class="mb-2 mb-xl-3 display-28"><span
                                                class="display-26 text-secondary me-2 font-weight-600">Classroom:</span>
                                            {{$classroom->name}}</li>
                                        <li class="mb-2 mb-xl-3 display-28"><span
                                                class="display-26 text-secondary me-2 font-weight-600">Position:</span>
                                            {{DB::table('classroom_user')->select('role')->where('user_id',$user->id)->first()->role}}
                                        </li>
                                        <li class="mb-2 mb-xl-3 display-28"><span
                                        ...
                                        <li class="display-28"><span
                                                class="display-26 text-secondary me-2 font-weight-600">Birthday:</span>{{ $user->profile->birthday }}
                                        </li>
                                    </ul>
                        ...
                        <div class="col-lg-12 mb-4 mb-sm-5">
                            ...
                            <div>
                                ...
                                <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their
                                    ...
                                    in
                                    their infancy.</p>
                                <p class="mb-1-9">There are many variations of passages of Lorem Ipsum available, but
                                    the
