            ...
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm @if($plan->featured) border-primary @endif">
                        <div class="card-header py-3 @if($plan->featured == 1) text-bg-primary border-primary @endif">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('subscriptions.store') }}" method="post">
                                ...
                                <button type="submit" class="w-100 btn btn-lg  btn-primary">Subscription</button>
                            </form>
                        </div>
                    </div>
                </div>
