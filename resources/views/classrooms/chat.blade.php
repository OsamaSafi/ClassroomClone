<x-main-layout :title="__('Classrooms Chat')">
    <div class="container">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9">
                                ...
                                <div class="chat-container">
                                    ...
                                    <form method="post" id="message-form" class="form-group row mt-3 mb-0">
                                        <div class="col-10">
    ...
    <script>
        const url = {
            list_message:"{{route('classrooms.messages.index',$classroom->id)}}",
            store_message:"{{route('classrooms.messages.store',$classroom->id)}}",
        };
        ...
        let classroom = "{{ $classroom->id }}";

        $(document).ready(function(){
            $(document).scrollLeft(function(e){
                $(this).scrollLeft('set',500);
            });
        })
